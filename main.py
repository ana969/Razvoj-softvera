# def main():
    ...
    first_time = input("Jete li već prije koristili aplikaciju? (da/ne): ")
    if first_time == "da":
        ...
        print("Uvijek je dobro početi! Ovako izgleda program: ")
        paper = int(input("Unesite broj kilograma recikliranog papira:"))
        bottles = int(input("Unesite broj recikliranih plastičnih boca:"))
        trees = paper / 10
        turtles = bottles / 200
    ...
    print("\nNastavi s recikliranjem. Svako mlo djelo pomaže!")
...
def main():
    ...
    if play_game.lower() == 'da':
        ...
        if score / len(questions) >= 0.75:
            ...
            print("Nasavi učiti, zajedno možemo napraviti svijet boljim mjestom za život!")
    else:
        print("U redu, dođi sljedeći put!")
